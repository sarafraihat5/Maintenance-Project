...
public class Loan {
	...
	public double computeFine1() {
		...
		if (!finePaid) {
			final var iDate = issuedDate;
			final var rDate = new Date();
	...
	public void payFine() {
		...
		final double totalFine = computeFine1();
	...
	public void renewIssuedBook(Date iDate) {
		...
		System.out.println(new StringBuilder().append("\nThe deadline of the book ").append(getBook().getTitle())
				.append(" has been extended.").toString());
