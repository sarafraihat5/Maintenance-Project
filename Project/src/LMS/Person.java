...
public abstract class Person {
	static int currentIdNumber = 0; // This will be unique for every person, since it will be incremented when
									// everytime
	...
	public Person(int idNum, String name, String address, int phoneNum) // para cons.
	{
		...
		id = idNum == -1 ? currentIdNumber : idNum;
	...
	public void printInfo() {
		...
		System.out.println(new StringBuilder().append("Phone No: ").append(phoneNo).append("\n").toString());
	}
